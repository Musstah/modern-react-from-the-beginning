...
const Navbar = () => {
    ...
    return (<nav className='bg-gray-800 border-b border-gray-700 sticky shadow-md top-0 z-50'>
        <div className="max-w-6xl mx-auto px-6 py-4 flex justify-between items-center">
            ...
            <div className="flex md:hidden items-center gap-4">
                <button onClick={() => setMenuOpen(!menuOpen)} className='text-blue-400 text-xl cursor-pointer' title='manu'>
